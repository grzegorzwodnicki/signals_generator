...
Cache: `strategy_wyckoff_9_5/cache/` · Wyniki: `strategy_wyckoff_9_5/results/`
...
```bash
python strategy_wyckoff_9_5/backtest.py --fuel-filter off   # czysty baseline v9.1
python strategy_wyckoff_9_5/backtest.py --fuel-filter on    # v9.3 z TFS (domyślny)
```
